                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select id="publisher_id" required type="text" class="form-control"
                                    placeholder="Enter  Publisher " name="publisher_id">
                                    <option selected disabled> - Select Publisher - </option>
                                    @foreach ($publishers as $publisher)
                                        <option value="{{ $publisher->id }}"><strong>{{ $publisher->store_name }}</strong> </option>
                                    @endforeach
                                </select>
                            </div>
                        </div> 
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input required type="password" class="form-control"
                                    placeholder="Enter  Confirmed Passoword" name="password_confirmation" id="conpass">
                            <div>
                                <span id="wrong" style="background-color: red;">Password is Incorrect</span>
                                <span id="right" style="background-color: green;">Password is correct</span>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input required type="number" class="form-control limitedTxt" placeholder="Enter Pin Code" maxlength="6" data-max-chars='6'
                    ...
                    <div class="col-sm-4">
                     ...
                     <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input  type="number" class="form-control limitedno" placeholder="Enter Gst No"
                                name="gst_no">
                        </div>
                    </div> 
