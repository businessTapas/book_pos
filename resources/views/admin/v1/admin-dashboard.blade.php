                                                            ...
                                                            <div class="col">
                                                                <div class="d-flex mt-2">
                                                                    ...
                                                                    <div class="flex-grow-1 ms-2 ps-1">
                                                                        ...
                                                                        <p class="text-muted text-truncate mb-0">Net Profit
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="d-flex mt-2">
                                                                    ...
                                                                    <div class="flex-grow-1 ms-2 ps-1">
                                                                        ...
                                                                        <p class="text-muted text-truncate mb-0">Net Revenue
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12 col-sm-5">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <h5 class="font-size-15 mb-1 text-truncate">Facebook Ads
                                                                </h5>
                                                ...
                                                <div class="social-box row align-items-center border-bottom g-0">
                                                    <div class="col-12 col-sm-5">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <h5 class="font-size-15 mb-1 text-truncate">linkedin Ads
                                                                </h5>
                                                ...
                                                <div class="social-box row align-items-center border-bottom g-0">
                                                    <div class="col-12 col-sm-5">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 overflow-hidden">
                                                                <h5 class="font-size-15 mb-1 text-truncate">Instagram Ads
                                                                </h5>
                                                                <p class="text-muted mb-0">Chairs</p>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="flex-grow-1 overflow-hidden me-4">
                                                                        <h5 class="font-size-15 mb-1 text-truncate">Have 5
                                                                            pending order.</h5>
                                                                        <p class="text-truncate text-muted mb-2">Delivered
                                                                        </p>
                                                                    </div>
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="flex-grow-1 overflow-hidden me-4">
                                                                        <h5 class="font-size-15 mb-1 text-truncate">New
                                                                            Order Received</h5>
                                                                        <p class="text-truncate text-muted mb-2">Pick Up
                                                                        </p>
                                                                    </div>
                                                                    <div class="flex-shrink-0 text-end">
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="flex-grow-1 overflow-hidden me-4">
                                                                        <h5 class="font-size-15 mb-1 text-truncate">Manager
                                                                            Posted</h5>
                                                                        <p class="text-truncate text-muted mb-2">In Transit
                                                                        </p>
                                                                    </div>
                                                                    <div class="flex-shrink-0 text-end">
                                                                        <h5 class="mb-1 font-size-15">Nov 03</h5>
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="flex-grow-1 overflow-hidden me-4">
                                                                        <h5 class="font-size-15 mb-1 text-truncate">Have 1
                                                                            pending order.</h5>
                                                                        <p class="text-truncate text-muted mb-2">2 hour ago
                                                                        </p>
                                                                    </div>
                                                                    <div class="flex-shrink-0 text-end">
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="flex-grow-1 overflow-hidden me-4">
                                                                        <h5 class="font-size-15 mb-1 text-truncate">Order
                                                                            Received</h5>
                                                                        <p class="text-truncate text-muted mb-2">Received
                                                                        </p>
                                                                    </div>
                                                                    <div class="flex-shrink-0 text-end">
                                                                        <h5 class="mb-1 font-size-15">Nov 04</h5>
                                                    ...
                                                    <div class="card dash-product-box shadow-none border mb-0">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="font-size-17 mt-1">
                                                                <a href="" class="text-reset lh-base">Stylish
                                                                    Cricket & Walking Light Weight Shoes</a>
                                                            </h5>
                                                            ...
                                                            <div class="mt-4">
                                                                <a href="" class="btn btn-primary btn-sm w-lg"><i
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="card dash-product-box shadow-none border mb-0">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="font-size-17 mt-1">
                                                                <a href="" class="text-reset lh-base">Combo Pack of
                                                                    2 Sports Shoes Running Shoes</a>
                                                            </h5>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="card dash-product-box shadow-none border mb-0">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="font-size-17 mt-1">
                                                                <a href="" class="text-reset lh-base">Trendy Men
                                                                    Sports Running Running Shoes</a>
                                                            </h5>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="card dash-product-box shadow-none border mb-0">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="font-size-17 mt-1">
                                                                <a href="" class="text-reset lh-base">Sneakers For
                                                                    Women Sports Running Shoes (Blue)</a>
                                                            </h5>
