    ...
    <div class="card-body table-responsive">
        <table class="table table-bordered " id="dynamic_field" style="overflow-y:auto;">
            ...
            <tbody>
                ...
                @php
                    $storage_sites = \App\Models\StorageSite::where('deleted_at', null)->where('created_by',  auth()->user()->id)->get();
                    $storage_locations = \App\Models\StorageLocation::where('deleted_at', null)->where('created_by',  auth()->user()->id)->get();
                    $racks = \App\Models\Rack::where('deleted_at', null)->where('created_by',  auth()->user()->id)->get();
