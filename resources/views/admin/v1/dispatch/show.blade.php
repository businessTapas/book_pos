                                        ...
                                        <div class="row">
                                            ...
                                            @if (isCentral())
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="to_store" name="to_store" required
                                                            class="form-control  " data-live-search="true"
                                                            placeholder="Enter  Supplier ">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly value="{{ date('Y-m-d') }}"
                                                    ...
                                                    <tbody>
                                                        @foreach ($data->details as $p)
                                                            <tr id="row{{ $loop->index + 1 }}">
                                                                ...
                                                                @else
                                                                    <td><input readonly onkeyup="cgstCal(this.value)"
                                                                            onclick="cgstCal(this.value)" type="number"
                                                                            name="array_cgst[]"
                                                                            value="{{ $p->cgst }}"
