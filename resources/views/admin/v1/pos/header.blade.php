<header id="page-topbar" class="pos-header mb-3">
        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="#" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo-lg.svg" alt="" height="26">
                    </span>
                </a>
                ...
                <a href="#" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo-lg-wh.svg" alt="" height="26">
                    </span>
                </a>
        ...
        <div class="d-flex">
            {{-- <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon"
                    ...
                    <i class="bx bx-cog" data-bs-toggle="tooltip" data-placement="bottom"
                        title="POS Setting"></i>
                </button>
            </div> --}}
            {{-- <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="bx bx-printer" data-bs-toggle="tooltip"
                        data-placement="bottom" title="Print Last Reciept"></i>
                </button>
            </div> --}}
            {{-- <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="bx bx-briefcase" data-bs-toggle="tooltip"
                        data-placement="bottom" title="Cash Register Details"></i>
                </button>
            </div> --}}
            {{-- <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="bx bx-shopping-bag" data-bs-toggle="tooltip"
                        data-placement="bottom" title="Today's Sales"></i>
                </button>
            </div> --}}
            {{-- <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="bx bx-line-chart" data-bs-toggle="tooltip"
                        data-placement="bottom" title="Today's Profit"></i>
                </button>
            </div> --}}
            ...
            {{-- <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon"
                    ...
                    <i class="bx bx-bell icon-sm" data-bs-toggle="tooltip"
                        data-placement="bottom" title="Notifications"></i>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="javascript:void(0);" class="small"> Mark all as
                                    read</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex border-bottom align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="text-muted">
                                        <p class="mb-1 font-size-13">Your task changed an
                                            issue
                                            from "In Progress" to <span
                                                class="badgebg-success-subtle text-success">Review</span>
                                        </p>
                                        <p
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex border-bottom align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="text-muted">
                                        <p class="mb-1 font-size-13">Open the order
                                            confirmation or shipment confirmation.</p>
                                        <p
                                            class="mb-0 font-size-10 text-uppercase fw-bold">
                                            <i class="mdi mdi-clock-outline"></i> 5 hours
                                            ago
                                        </p>
                                    </div>
                                </div>
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex border-bottom align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="text-muted">
                                        <p class="mb-1 font-size-13">Here is somthing that
                                            you
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex border-bottom align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="text-muted">
                                        <p class="mb-1 font-size-13">Yay ! Everything
                                            worked!
                                        </p>
                                        <p
                                            class="mb-0 font-size-10 text-uppercase fw-bold">
                    ...
                    <div class="p-2 border-top d-grid">
                        <a class="btn btn-sm btn-link font-size-14 btn-block text-center"
                            ...
                            <i class="uil-arrow-circle-right me-1"></i> <span>View
                                More..</span>
                        </a>
                    </div>
                </div>
                            ...
                            <div class="row row-cols-xxl-6 row-cols-md-3 row-cols-1 g-0">
                                ...
                                <div class="col">
                                    <div class="mt-3 mt-md-0 py-3 px-4 mx-2">
                                        <p class="text-white-50 mb-2 text-truncate">Annual
                                            Profit</p>
                                ...
                                <div class="col">
                                    <div class="mt-3 mt-md-0 py-3 px-4 mx-2">
                                        <p class="text-white-50 mb-2 text-truncate">Lead
                                            Coversation</p>
                                ...
                                <div class="col">
                                    <div class="mt-3 mt-md-0 py-3 px-4 mx-2">
                                        <p class="text-white-50 mb-2 text-truncate">Sales
                                            Forecast</p>
                                ...
                                <div class="col">
                                    <div class="mt-3 mt-lg-0 py-3 px-4 mx-2">
                                        <p class="text-white-50 mb-2 text-truncate">Daily
                                            Average Income</p>
