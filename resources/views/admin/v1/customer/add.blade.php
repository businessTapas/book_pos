                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title text-capitalize">Create Customer by Retail</h4>
                                </div>
                                <a class="btn btn-primary add-list btn-sm text-white"
                                href="{{route('retail.customer')}}"><i class="las la-plus mr-3"></i>Back to
                                List</a>
                            </div>
                            <div class="card-body">
                                <form id="form_data" action="{{ route('retail.add') }}" method="POST">
                                    @csrf
                                    <div class="row">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementsByName("dob")[0].setAttribute("min", minDateFormatted);
