        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                @if (auth()->user()->type !== 'publisher' && auth()->user()->type !== 'admin' && auth()->user()->type !== 'central-store')
                    <a class="btn header-item noti-icon text-white mt-5" target="_blank"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="text-muted">
                                        <p class="mb-1 font-size-13">Your task changed an issue from "In
                                            Progress" to <span class="badgebg-success-subtle text-success">Review</span>
                                        </p>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item user mt-4 text-start d-flex align-items-center"
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 sub-title text-capitalize">{{ auth()->user()->name }} -
                            {{ auth()->user()->type }}</h4>
                            ...
                            <div class="row row-cols-xxl-3 row-cols-md-3 row-cols-1 g-0">
                                <div class="col">
                                    <div class="mt-md-0 py-3 px-4 mx-2">
                                        <p class="text-white-50 mb-2 text-truncate">New Customers </p>
                                        <h5 class="text-white mb-0 text-capitalize">Today nos - 197</h5>
                                        <h5 class="text-white mb-0 text-capitalize">This Month no - 1970</h5>
                                    </div>
                                </div><!-- end col -->

                                <div class="col">
                                    <div class="mt-3 mt-md-0 py-3 px-4 mx-2">
                                        <p class="text-white-50 mb-2 text-truncate">New Sales </p>
                                        <h5 class="text-white mb-0 text-capitalize">Today nos - 197</h5>
                                        <h5 class="text-white mb-0 text-capitalize">This Month no - 1970</h5>
                                    </div>
                                </div><!-- end col -->
                                ...
                                <div class="col">
                                    <div class="mt-3 mt-md-0 py-3 px-4 mx-2">
                                        <p class="text-white-50 mb-2 text-truncate">Low Stock Items </p>
                                        <h5 class="text-white mb-0 text-capitalize">Nos - 197</h5>
                                    </div>
                                </div><!-- end col -->
